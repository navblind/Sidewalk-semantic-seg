...
parser.add_argument('--crop_height', type=int, default=180, help='Height of cropped input image to network')
parser.add_argument('--crop_width', type=int, default=240, help='Width of cropped input image to network')
...
print(os.path.join(args.dataset, "classes.csv"))
class_names_string = ""
...
for epoch in range(args.epoch_start_i, args.num_epochs):
    ...
    for i in range(num_iters):
        ...
        # Do the training
        anythin,current=sess.run([opt,loss],feed_dict={net_input:input_image_batch,net_output:output_image_batch})
